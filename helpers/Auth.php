...
class Auth
{
    ...
    public static function addAdminCommentToTicket($id, $comment, $name=null)
    {
        $manager_db = new DbAcess('ssenhogv_manager');
    ...
    {
        $managerDb = new DbAcess('ssenhogv_manager');
    ...
    public static function sendStaffMail($mailer,$company,$staff_email ,$subject,$message){
                    ...
                    <tr>
                        <td>
                            <table width=\"95%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\"
                                ...
                                <tr>
                                    <td style=\"padding:0 35px;\">
                                        <h1 style=\"color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;\">Reminder Alert </h1>
                                        <span
                                            style=\"display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;\"></span>
                                        <p style=\"color:#455056; font-size:15px;line-height:24px; margin:0;\">
                                            $message
