...
class Logger
{
    ...
    public static function createLogFile()
    {
        ...
        $base = __DIR__ . '/../../' . 'uploads/allfiles';
        $time = date(static::$options['dateFormat']);
        static::$log_file = $base . "/logs/log-{$time}.txt";
    ...
    public static function log_header($heading)
    {
        self::info("=====================================================");
        self::info($heading);
        self::info("=====================================================");
    ...
    public static  function writeLog($args = [])
    {
        ...
        fwrite(static::$file, "{$timeLog}: {$severityLog} \t-\t{$messageLog} {$contextLog}" . PHP_EOL);
    ...
    public static function renderLog($logFile, $callBack = '')
    {
        $content = file($logFile);
        if (is_callable($callBack)) {
            $content =  call_user_func_array($callBack, array($content));
        }
